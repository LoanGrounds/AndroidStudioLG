...
public class ListaAdaptadoraSolicitados extends ArrayAdapter<VistaPreviaPrestamo> {
    ...
    public ListaAdaptadoraSolicitados(Context mCtx, int resource, List<VistaPreviaPrestamo> ListaPrestamos){
